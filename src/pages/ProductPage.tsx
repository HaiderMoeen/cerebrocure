...
export const ProductPage: React.FC<ProductPageProps> = ({ onNavigate }) => (
  <div className="w-full flex flex-col items-center animate-fade-in">
    ...
    {/* Product Grid: Workflow (1.85fr) + Billing (1fr) */}
    <section className="relative z-10 w-full -mt-[4vh] lg:-mt-[6vh] px-4 sm:px-6 lg:px-10 max-w-[1180px] mx-auto animate-fade-in-delay-1">
